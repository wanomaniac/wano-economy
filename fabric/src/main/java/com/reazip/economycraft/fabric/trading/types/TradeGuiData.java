...
public record TradeGuiData(UUID playerA, UUID playerB, boolean isA, Long extraMoneyA, Long extraMoneyB) {
    public static final StreamCodec<RegistryFriendlyByteBuf, TradeGuiData> PACKET_CODEC =
            new StreamCodec<>() {
                ...
                public TradeGuiData decode(RegistryFriendlyByteBuf buf) {
                    ...
                    return new TradeGuiData(a, b, isA, extraMoneyA, extraMoneyB);
                }
