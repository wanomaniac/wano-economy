package com.wanomaniac.economy.util;
...
public final class ChatCompat {
    ...
    public static void sendRunCommandTellraw(ServerPlayer target, String prefixText, String labelText, String cmd) {
        try {
            ...
            srv.getCommands().performPrefixedCommand(OperatorCommandUtils.setCommandSourceStackWithPermissions(srv.createCommandSourceStack()), line);
        } catch (Throwable ignored) {
