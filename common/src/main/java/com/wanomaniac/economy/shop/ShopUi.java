package com.wanomaniac.economy.shop;

import com.wanomaniac.economy.CommonEconomy;
import com.wanomaniac.economy.EconomyConfig;
        ...
        private void updatePage() {
            ...
            for (int i = 0; i < 45; i++) {
                ...
                if (sellerPlayer != null) {
                    ...
                    sellerName = CommonEconomy.getManager(viewer.level().getServer()).getBestName(l.seller);
                }
                ...
                display.set(net.minecraft.core.component.DataComponents.LORE, new net.minecraft.world.item.component.ItemLore(List.of(
                        Component.literal("Price: " + CommonEconomy.formatMoney(l.price) + " (+" + CommonEconomy.formatMoney(tax) + " tax)"),
    ...
    private static class ConfirmMenu extends AbstractContainerMenu {
        ...
        ConfirmMenu(int id, Inventory inv, ShopManager shop, ShopListing listing, ServerPlayer viewer) {
            ...
            if (sellerPlayer != null) {
                ...
                sellerName = CommonEconomy.getManager(viewer.level().getServer()).getBestName(listing.seller);
            }
            ...
            item.set(net.minecraft.core.component.DataComponents.LORE, new net.minecraft.world.item.component.ItemLore(List.of(
                    Component.literal("Price: " + CommonEconomy.formatMoney(listing.price) + " (+" + CommonEconomy.formatMoney(tax) + " tax)"),
                    Component.literal("Seller: " + sellerName))));
            ...
            if (type == ClickType.PICKUP) {
                if (slot == 2) {
                    ...
                    if (current == null) {
                        ...
                        EconomyManager eco = CommonEconomy.getManager(server);
                            ...
                            if (!player.getInventory().add(stack)) {
                                ...
                                sp.sendSystemMessage(
                                        Component.literal("Purchased " + count + "x " + name.getString() + " from " + sellerName +
                                                        " for " + CommonEconomy.formatMoney(total))
